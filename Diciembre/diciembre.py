...
ruta_datos = r"C:\Users\eyleen.godoy_arbusta\Desktop\Consolidar datos\Diciembre\DatosEncontradosDiciembre"
...
def extraer_nombre_analista(nombre_archivo):
    ...
    try:
        # Asumiendo formato "QA Calidad Nombre Apellido.xlsx"
        partes = nombre_archivo.replace("QA Calidad ", "").replace(".xlsx", "").strip()
        return partes
...
def unificar_archivos():
    ...
    # Guardar resultado
    archivo_salida = os.path.join(ruta_salida, "DatosEncontradosDiciembreUnificados.xlsx")
